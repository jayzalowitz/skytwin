...
/**
 * Fixed-role, fail-closed source-key broker boundary for the worker child.
 *
 ...
 */
export const workerSourceKeyBrokerClient =
  createProcessSourceKeyBrokerClient('worker');
