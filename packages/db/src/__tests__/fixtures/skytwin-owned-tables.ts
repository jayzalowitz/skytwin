...
export const SKYTWIN_OWNED_TABLES = [
  ...
  'credential_requirements', 'cross_domain_traits', 'decision_ingest_guards',
  ...
  'execution_results', 'explanation_records', 'external_agent_tokens',
  ...
  'memory_tunnels', 'memory_wings', 'model_downloads', 'oauth_pending_signin',
  'oauth_pkce_pending', 'oauth_tokens', 'pending_skill_opt_ins',
  'preference_history', 'preference_proposals', 'preferences', 'proactive_scans',
  'promotion_offers', 'recovery_codes', 'service_credentials', 'sessions', 'signals',
  'skill_gap_log', 'spend_records', 'trust_tier_audit', 'twin_briefings',
  'twin_exports', 'twin_profile_versions', 'twin_profiles',
  'user_credential_vault_meta', 'user_onboarding_state', 'user_risk_profiles',
  'users', 'watch_runs', 'watches', 'worker_dead_letter',
] as const;
