...
| `assistant_messages` | Chat turns; new writes carry owner-scoped request identity and processing metadata | Once per logical turn | Thread history and completed retry replay |
